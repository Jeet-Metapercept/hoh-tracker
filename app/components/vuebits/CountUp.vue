...
// CountUp — spring-based number count-up animation. From Vue Bits
// (https://vue-bits.dev/text-animations/count-up). Auto-imported as
// <VuebitsCountUp /> (path components/vuebits/CountUp.vue).
import {
  ref,
  onMounted,
  onUnmounted,
...
watch(
  ...
  () => {
    ...
    // Re-trigger the animation toward the new target when already in view.
